...
if (knitr::is_html_output()) {
  cat('
<iframe title="Houston’s Most Common Low-Wage Jobs" aria-label="Table" id="datawrapper-chart-BfgTT" src="https://datawrapper.dwcdn.net/BfgTT/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe>
<script type="text/javascript">
!function(){"use strict";window.addEventListener("message",(function(a){
  if(void 0!==a.data["datawrapper-height"]){
    var e=document.querySelectorAll("iframe");
