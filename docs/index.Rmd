...
This project investigates how Houston’s job market deviates from the broader Texas economy—both in terms of wages and employment structure. Using occupational wage and employment statistics from the U.S. Bureau of Labor Statistics, I examine disparities in pay, job concentration, and industry-level growth over the past decade.
...
**3-SeriesReport**: Based on the U.S. Bureau of Labor Statistics’ [State and Area Employment, Hours, and Earnings](https://data.bls.gov/PDQWeb/sa) (SAE) dataset. This time series data provides monthly employment figures by industry sector for specific metropolitan areas. I downloaded separate reports for five sectors within the Houston-The Woodlands-Sugar Land, TX MSA. For each sector, I used non-seasonally adjusted monthly data from 2015 to 2024.
...
<iframe title="Top 10 Jobs Underpaid in Houston Compared to Texas" aria-label="Range Plot" id="datawrapper-chart-FVp3S" src="https://datawrapper.dwcdn.net/FVp3S/6/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1">
...
<iframe title="Houston’s Most Common Low-Wage Jobs" aria-label="Table" id="datawrapper-chart-BfgTT" src="https://datawrapper.dwcdn.net/BfgTT/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1">
...
To understand long-term employment trends, I wanted a clearer picture than a single month could provide. So instead of looking at just December—often skewed by seasonal cycles or year-end fluctuations—I calculated the annual average employment for each sector, using monthly data from January through December.
